    ...
    <Layout>
      <div className="container mx-auto px-4 py-12 max-w-6xl">
        ...
        <div className="glass-card p-8 md:p-12">
          ...
          >
            <h2 className="text-2xl font-bold tracking-tight">MindMatrix for College Students Access</h2>
          </button>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <motion.div
                ...
                transition={{ duration: 0.3 }}
              >
                <h2 className="text-xl font-semibold mb-6">Verify Your College Enrollment</h2>
                <CollegeVerificationForm onSubmit={handleCollegeVerification} onBack={handleBack} />
              </motion.div>
            ) : (
              <motion.div
              ...
              >
                ...
                <div>
                  <h2 className="text-xl font-semibold mb-6">
                    Create your {selectedRole === 'college-credit-student' ? 'Student' : 
                    selectedRole === 'professional' ? 'Professional' : 
                    selectedRole === 'independent' ? 'Job Seeker' : 
                    'College Access'} account
                  </h2>
